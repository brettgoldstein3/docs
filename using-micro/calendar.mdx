...
<div className="my-8">
  <img src="/images/cal-light.png" alt="Micro Platform Overview" className="rounded-lg shadow-lg dark:hidden" />
  <img src="/images/cal-dark.png" alt="Micro Platform Overview" className="rounded-lg shadow-lg hidden dark:block" />
</div>  
